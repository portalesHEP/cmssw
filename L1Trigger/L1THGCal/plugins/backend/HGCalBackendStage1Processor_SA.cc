#include "L1Trigger/L1THGCal/interface/backend/HGCalBackendStage1Processor_SA.h"
#include "DataFormats/ForwardDetId/interface/HGCalTriggerBackendDetId.h"

DEFINE_EDM_PLUGIN(HGCalBackendStage1Factory, HGCalBackendStage1ProcessorSA, "HGCalBackendStage1ProcessorSA");

HGCalBackendStage1ProcessorSA::HGCalBackendStage1ProcessorSA(const edm::ParameterSet& conf)
...
void HGCalBackendStage1ProcessorSA::run(const std::pair<uint32_t,
                                                        std::vector<edm::Ptr<l1t::HGCalTriggerCell>>>& fpga_id_tcs,
